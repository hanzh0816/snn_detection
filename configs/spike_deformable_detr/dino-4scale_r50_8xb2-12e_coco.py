_base_ = ["./multimodal_dataset_no_aug.py", "../_base_/default_runtime.py"]
model = dict(
    type="DINO",
    ...
    encoder=dict(
        ...
        layer_cfg=dict(
            ...
            ffn_cfg=dict(
                embed_dims=256, feedforward_channels=2048, ffn_drop=0.0  # 1024 for DeformDETR
            ),
        ),
    ),  # 0.1 for DeformDETR
    decoder=dict(
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(project="snn_detection", name="dino-baseline"),
    ),
]
